...
- [x] 3.5 Form shows 8 fields with correct icons and placeholders
- [x] 3.6 Empty city shows "City is required" error
- [x] 3.7 Invalid width "abc" shows "Enter a valid number" error
- [x] 3.8 Width 101 shows range error
- [x] 3.9 Valid data passes client validation
...
- [x] 4.4 Valid signup creates auth user + profile with correct data
- [x] 4.5 Invalid city "XYZ123NotACity" shows error
- [x] 4.6 Width 101 shows server validation error
- [x] 4.7 Missing city shows zod error
- [x] 4.8 Duplicate email shows Supabase error
...
- [x] 5.2 Integration tests pass: `npm run test:integration` (no signup tests exist yet)
