...
- [ ] 2.3 No unused imports/exports

#### Manual

- [ ] 2.4 IntelliSense works for new types in IDE
- [ ] 2.5 All interfaces export correctly
- [ ] 2.6 Weather data structure matches API docs
